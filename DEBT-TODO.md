...
## Summary
- All previously tracked core/CLI parsing and task-loading debts are resolved in this pass.
- Task domain logic is now split into focused modules with tests and safer parser error handling.
- CLI wrapping behavior now uses explicit hanging-indent detection and `blocks:` parsing is implemented.
