...
use super::filters_impl::{
    ...
    FilterKind, OrFilter, ProjectFilter, StatusFilter, StringFilter, TagFilter, TaskIdFilter,
    UuidFilter, XorFilter,
};
use super::{Filter, new_empty};
        ...
        while self.current_token.token_type != TokenType::Eof {
            match self.current_token.token_type {
                ...
                TokenType::ProjectPrefix => {
                    *has_only_ids = false;
                    ...
                    let project_filter = Box::new(ProjectFilter {
                        name: Project::from(project_name),
                    });
                ...
                TokenType::DependsOn => {
                    ...
                    let depends_on_filter = match self.current_token.token_type {
                        TokenType::Int => Box::new(DependsOnFilter {
                            id: Some(
                                self.current_token
                                    .literal
                                    .parse::<usize>()
                        ...
                        TokenType::Uuid => Box::new(DependsOnFilter {
                            uuid: Some(
                                self.current_token
                                    .literal
                                    .parse::<Uuid>()
